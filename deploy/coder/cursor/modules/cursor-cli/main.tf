...
module "agentapi" {
  ...
  # VENDORIZADO. O agentapi 2.0.0 mudou o default de `agentapi_subdomain` para
  # true, e o cursor-cli 0.3.0 nao expoe esse input. Num deployment sem
  # CODER_WILDCARD_ACCESS_URL — que e' o caso da frota, por causa do custo de um
  # certificado de 3o nivel — o painel de chat da task morre com "This
  # application has subdomain = true". agentapi v0.10.0 >= v0.3.3, entao o modo
  # por caminho e' suportado. Esta e' a UNICA alteracao em relacao ao upstream.
